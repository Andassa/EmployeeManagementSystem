    ...
    public partial class Salary : UserControl
    {
        ...
        private void salary_updateBtn_Click(object sender, EventArgs e)
        {
            if(salary_employeeID.Text == ""
                ...
                || salary_salary.Text == "")
            {
                MessageBox.Show("Veuillez remplir tous les champs", "Error Message"
                    , MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                DialogResult check = MessageBox.Show("Etes vous vramient sur de mettre à jour l'employée ID: "
